...
namespace Sandsunder.Simulation
{
    ...
    public readonly struct CombatRules
    {
        ...
        public static readonly CombatRules PrototypeOne = new CombatRules(
            ...
            spitterDamage: 12,
            spitterAttackIntervalTicks: 140,
            spitterProjectileSpeedMillimetresPerSecond: 3600,
            spitterAttackRangeMillimetres: 7000,
            spitterPreferredRangeMillimetres: 5200,
            spitterMoveSpeedMillimetresPerSecond: 1500,
